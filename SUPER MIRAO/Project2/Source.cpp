...
private:
	...
	// Using as Sprite selection flags
	int nDirModX = 0;
	int nDirModY = 0;
...
protected:
	virtual bool OnUserCreate()
	{
		...
		sLevel += L"...................................oo......o..............o.....";
		sLevel += L"..............................B............B..............B.....";
		sLevel += L".......ooooo......................B...B............o..B.........";
		sLevel += L"........ooo.....................................................";
		sLevel += L".......................########...................B.............";
		sLevel += L"...B.B?B.BB?BB.......###..............#.#.......................";
		sLevel += L"....................###................#.#.....B................";
		sLevel += L"...................####.........................................";
	...
	virtual bool OnUserUpdate(float fElapsedTime)
	{
		...
		// Linking camera to player position
		...
		// Calculating Top-Leftmost visible tile
		...
		// Draw visible tile map as per Sprite Graphics
...
int main()
{
	...
	if (game.ConstructConsole(200, 190, 2, 2))
		game.Start();
	return 0;
}